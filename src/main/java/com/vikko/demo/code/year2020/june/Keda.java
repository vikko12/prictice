...
public class Keda {
    ...
    private static final String APPID = "5ee9b806";
    private static final String API_KEY = "777e534c8a33dd6d16c99c5b5f3fd11c";
    ...
    private static final String AUTH_ID = "2894c985bf8b1111c6728db79d3479a4";
    private static final String AUE = "raw";
    private static final String FILE_PATH = "C:\\Users\\vikko\\Desktop\\a.txt";
    // 个性化参数，需转义
...
//        byte[] dataByteArray = readFile(FILE_PATH);
        byte[] dataByteArray = "把如意词语接龙打开".getBytes("UTF-8");
